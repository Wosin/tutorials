...
public class FlowableTest {
    ...
    @Test public void givenFlowableWithMissingStrategy_whenSourceEmitsFasterThanConsumerConsumes_thenExceptionIsThrown() throws InterruptedException {
    ...
    @Test public void givenFlowableWithErrorStrategy_whenSourceEmitsFasterThanConsumerConsumes_thenExceptionIsThrown() throws InterruptedException {
        Observable observable = Observable.range(1, 100000);
    ...
    @Test public void givenFlowableWithLatestStrategy_whenSourceEmitsFasterThanConsumerConsumes_thenExceptionIsThrown() throws InterruptedException {
        List testList = IntStream.range(0, 100000).boxed().collect(Collectors.toList());
        Observable observable = Observable.fromIterable(testList);
